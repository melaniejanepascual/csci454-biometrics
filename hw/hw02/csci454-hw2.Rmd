...
difference <- c()
for(i in 1:length(images.test)) {
  difference <- cbind(abs(images.test[i, i]-images.test[i + 1, i + 1]))
 
}

## when looking at 2 columns. Subtract the difference, get the absolute and then sum everything up
